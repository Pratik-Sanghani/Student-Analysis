...
<html>
    ...
    <body style="margin-top: -40px;">
        ...
        //response.sendRedirect("home.jsp?user=old");
            %>
        <form class="form-signin" action="edit_mark.jsp" method="post" align="center" >
        <h2 class="form-signin-heading" align="center">Update Your Grade...</h2><br/>
        
             <br/>
             <input type="text" id="inputsub" class="form-control" placeholder="Subject" name="subject" value="<%= sub %>" required autofocus>
        <br/>
        <input type="text" id="inputgrade" class="form-control" placeholder="New Grade" name="grade" required>
         <br/>
